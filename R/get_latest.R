...
#'
#' Identifies tiles with multiple acquisitions and returns only the latest (newest)
...
#' get_latest(f)
#'
#' @seealso \code{\link{get_first}}, \code{\link{check_multitemporal}}, \code{\link{resolve_vpc}}
#'
#' @export
#'
get_latest <- function(path, entire_tiles = TRUE, tolerance = 1, full.names = FALSE, multitemporal_only = FALSE, out_file = NULL) {
