...
[managelidar](https://github.com/wiesehahn/managelidar) is a LiDAR
catalog processing engine for R that builds on top of
{[lasR](https://github.com/r-lidar/lasR)}. While lasR efficiently
handles individual LASfile processing and basic handling of Virtual
Point Clouds (VPC), managelidar adds catalog-level capabilities,
...
#>     xmin    ymin     xmax    ymax
#> 1 547648 5724000 548995.4 5726000
...
Think of it as: managelidar handles the catalog-level processing, then
lasR handles the point cloud processing
